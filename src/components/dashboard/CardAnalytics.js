  ...
  return (
    <><h2
      style={{
        ...
        bottom: isUploader?"37%" : "0px",
        right:isUploader ? "9%" :"",
        position: "relative"
      }}>
      {isAdminOrDocumentRole ? "" : "Company Count"}
    </h2><div
      className="analytics-card"
      style={{
        background: isUploader ? "" : "linear-gradient(135deg, #f857a6 0%, #ff5858 100%)",
        color: isUploader ? "black" : "white",
        padding: "20px",
        borderRadius: "20px",
        boxShadow: isUploader ? " " : "0 4px 15px rgba(0,0,0,0.2)",
        width: "100%",
        // maxWidth: isUploader ? "290px" : "400px", // ✅ Expand if uploader
        ...(isAdminOrDocumentRole
          ? {
            marginRight: isUploader?"25%": "0px",
            ...
            left: isUploader ? "" : "4%",
            width: isUploader ? "56%" : "300px", // ✅ Expand for uploader\
            background: isUploader ? "" : "#fff",
          }
              ...
              <>
                <div style={{
                  ...
                  <div style={{
                    ...
                    <Item label="Total Documents" value={DashboardStats?.document_count || 0} icon={<GrDocument />} /></div>
                  <div style={{
                    flex: "1 1 45%",
                    display: "flex",
                    alignItems: "center",
