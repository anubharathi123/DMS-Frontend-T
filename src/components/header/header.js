...
import NotificationDropdown from "../NotificationDropdown/NotificationDropdown"; // Import the component
import "./header.css";
...
const Header = () => {
  ...
  const { profileImage } = useProfileImage(); // Get the profile image from the shared context
